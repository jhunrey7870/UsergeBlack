...
noPmMessage = bk_noPmMessage = ("Heya {fname}, this is an automated message\n"
                                "Please wait until you get approved to direct message."
                                "Don't spam until then or you'll catch a block.")
...
@userge.on_cmd("nopm", about={
    ...
    'description': "Ones someone is allowed, "
                   "UsergeBlack will not interfere or handle such private chats",
