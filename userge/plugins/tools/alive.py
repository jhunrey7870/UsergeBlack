...
"""
        ...
        copy_ = "https://github.com/BlackStoneOfficial/UsergeBlack/blob/master/LICENSE"
        markup = InlineKeyboardMarkup([
            [
                InlineKeyboardButton(text="👥 BlackStone", url="https://github.com/BlackStoneOfficial"),
